...
public class HomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView viewGroupTextView = findViewById(R.id.viewGroupTextView);
        TextView createGroupTextView = findViewById(R.id.createGroupTextView);
        TextView joinGroupTextView = findViewById(R.id.joinGroupTextView);
        ...
        joinGroupTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openJoinGroup();
            }
        });
        createGroupTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openCreateGroup();
            }
